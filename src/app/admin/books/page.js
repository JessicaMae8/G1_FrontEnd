...
const BooksTable = () => {
  ...
  return (
    <div className="py-[40px] px-[30px] h-screen pb-[50px] bg-gray-950 text-white mr-[14px]">
              ...
              >
                ...
                <td className="px-6 py-4">
                  {book.image && book.image.trim() !== '' ? (
                    ...
                    <div className="h-12 w-9 bg-gray-600 rounded" />
                  )}
                </td>
            ...
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                className={`px-3 py-1 rounded ${
                  currentPage === i + 1 ? 'bg-blue-600 text-white' : 'bg-gray-600 text-gray-200'
                }`}
              >
                {i + 1}
              </button>
      ...
      <AddModal isOpen={addModalOpen} onClose={() => setAddModalOpen(false)} onSave={handleSaveBook} />
      <DeleteModal isOpen={deleteModalOpen} onClose={() => setDeleteModalOpen(false)} onDelete={handleDeleteBook} book={selectedBook} />
    </div>
  );
};
